      ...
      <div className="flex justify-between items-center mt-6">
        ...
        <div className="flex space-x-4">
          <a href="#" aria-label="Facebook">
            <FaFacebook className="h-5 w-5 text-blue-900 hover:text-blue-700" />
          </a>
          <a href="#" aria-label="LinkedIn">
            <FaLinkedin className="h-5 w-5 text-blue-900 hover:text-blue-700" />
          </a>
          <a href="#" aria-label="Twitter">
            <FaTwitter className="h-5 w-5 text-blue-900 hover:text-blue-700" />
          </a>
          <a href="#" aria-label="WhatsApp">
            <FaWhatsapp className="h-5 w-5 text-blue-900 hover:text-blue-700" />
          </a>
        </div>
      </div>
    </div>
